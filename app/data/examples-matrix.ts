...
export const examplesMatrix: ExamplesMatrix = {
  ...
  'business-development-specialist': {
    'technical-team': [
      ex('business-development-specialist', 'technical-team', 0, 'i-heroicons-document-text'),
      ex('business-development-specialist', 'technical-team', 1, 'i-heroicons-beaker'),
      ex('business-development-specialist', 'technical-team', 2, 'i-heroicons-chart-bar'),
      ex('business-development-specialist', 'technical-team', 3, 'i-heroicons-clipboard-document-list'),
      ex('business-development-specialist', 'technical-team', 4, 'i-heroicons-code-bracket'),
    ],
    'executives': [
      ex('business-development-specialist', 'executives', 0, 'i-heroicons-presentation-chart-bar'),
      ex('business-development-specialist', 'executives', 1, 'i-heroicons-light-bulb'),
      ex('business-development-specialist', 'executives', 2, 'i-heroicons-currency-dollar'),
      ex('business-development-specialist', 'executives', 3, 'i-heroicons-document-text'),
      ex('business-development-specialist', 'executives', 4, 'i-heroicons-arrow-trending-up'),
    ],
    'clients': [
      ex('business-development-specialist', 'clients', 0, 'i-heroicons-document-text'),
      ex('business-development-specialist', 'clients', 1, 'i-heroicons-chart-bar'),
      ex('business-development-specialist', 'clients', 2, 'i-heroicons-light-bulb'),
      ex('business-development-specialist', 'clients', 3, 'i-heroicons-presentation-chart-line'),
      ex('business-development-specialist', 'clients', 4, 'i-heroicons-check-badge'),
    ],
    'general-public': [
      ex('business-development-specialist', 'general-public', 0, 'i-heroicons-newspaper'),
      ex('business-development-specialist', 'general-public', 1, 'i-heroicons-light-bulb'),
      ex('business-development-specialist', 'general-public', 2, 'i-heroicons-question-mark-circle'),
      ex('business-development-specialist', 'general-public', 3, 'i-heroicons-megaphone'),
      ex('business-development-specialist', 'general-public', 4, 'i-heroicons-chart-bar'),
    ],
    'students': [
      ex('business-development-specialist', 'students', 0, 'i-heroicons-academic-cap'),
      ex('business-development-specialist', 'students', 1, 'i-heroicons-book-open'),
      ex('business-development-specialist', 'students', 2, 'i-heroicons-beaker'),
      ex('business-development-specialist', 'students', 3, 'i-heroicons-light-bulb'),
      ex('business-development-specialist', 'students', 4, 'i-heroicons-document-text'),
    ],
    'experts': [
      ex('business-development-specialist', 'experts', 0, 'i-heroicons-beaker'),
      ex('business-development-specialist', 'experts', 1, 'i-heroicons-document-text'),
      ex('business-development-specialist', 'experts', 2, 'i-heroicons-chart-bar-square'),
      ex('business-development-specialist', 'experts', 3, 'i-heroicons-magnifying-glass'),
      ex('business-development-specialist', 'experts', 4, 'i-heroicons-arrow-trending-up'),
    ],
    'beginners': [
      ex('business-development-specialist', 'beginners', 0, 'i-heroicons-light-bulb'),
      ex('business-development-specialist', 'beginners', 1, 'i-heroicons-book-open'),
      ex('business-development-specialist', 'beginners', 2, 'i-heroicons-beaker'),
      ex('business-development-specialist', 'beginners', 3, 'i-heroicons-question-mark-circle'),
      ex('business-development-specialist', 'beginners', 4, 'i-heroicons-check-circle'),
    ],
    'stakeholders': [
      ex('business-development-specialist', 'stakeholders', 0, 'i-heroicons-presentation-chart-line'),
      ex('business-development-specialist', 'stakeholders', 1, 'i-heroicons-document-chart-bar'),
      ex('business-development-specialist', 'stakeholders', 2, 'i-heroicons-light-bulb'),
      ex('business-development-specialist', 'stakeholders', 3, 'i-heroicons-flag'),
      ex('business-development-specialist', 'stakeholders', 4, 'i-heroicons-banknotes'),
    ],
    'team-members': [
      ex('business-development-specialist', 'team-members', 0, 'i-heroicons-document-text'),
      ex('business-development-specialist', 'team-members', 1, 'i-heroicons-beaker'),
      ex('business-development-specialist', 'team-members', 2, 'i-heroicons-share'),
      ex('business-development-specialist', 'team-members', 3, 'i-heroicons-chat-bubble-left-right'),
      ex('business-development-specialist', 'team-members', 4, 'i-heroicons-clipboard-document-list'),
    ],
  },
}
